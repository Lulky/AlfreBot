public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGuestGreeting = alfredBot.guestGreeting("Luciano Usnayo");
        String testDateAnnouncement = alfredBot.dateAnnouncement();
        
        String alexisTest = alfredBot.respondBeforeAlexis("¡Alexis! Toca algunos beats low-fi.");
        String alfredTest = alfredBot.respondBeforeAlexis("No puedo encontrar mi yo-yo. Quizas Alfred sepa dónde esta");
        String testDateNameGreeting = alfredBot.notRelevantTest("Luciano", "viernes");
        ...
        System.out.println(testDateNameGreeting);
    }
}